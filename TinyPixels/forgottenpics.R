library(stringr)
library(png)
setwd("/home/ericschulz/Desktop/TinyFractals/proppics/")
...
for (i in seq_along(names)){
  ...
  png(paste0("/home/ericschulz/Desktop/TinyFractals/proppics/", names[i], ".png"), width=225, height=225)
...
for (i in seq_along(names)){
  ...
  png(paste0("/home/ericschulz/Desktop/TinyFractals/inventpic/",names[i], '.png'), width=300, height=300)
