...
var myDataRef = new Firebase('https://functionsdata.firebaseio.com/');
...
function mysubmit()
{
  ...
  if (turkid=="WorkerID")
  	...
  	}else
  	{
		...
		var presentmoney='You will be paid $3.00 for your participation.';
		//show score and money
		change('result',presenttotal); 
		change('money',presentmoney);
		var tinynew=1;
		//save all created values
		myDataRef.push({collect: collect, tinynew: tinynew, elements: elements, money: money, 
